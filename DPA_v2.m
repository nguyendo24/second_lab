...
traces = myload('C:\Users\Nhat\Documents\Learning\Matlab\SCA-DPA-master\Samples\traces-00112233445566778899aabbccddeeff.bin', traceSize, offset, segmentLength, numberOfTraces);
...
plaintext = myin('C:\Users\Nhat\Documents\Learning\Matlab\SCA-DPA-master\Samples\plaintext-00112233445566778899aabbccddeeff.txt', columns, rows);
ciphertext = myin('C:\Users\Nhat\Documents\Learning\Matlab\SCA-DPA-master\Samples\ciphertext-00112233445566778899aabbccddeeff.txt', columns, rows);
...
offset = 50000;
segmentLength = 40000;
traces2 = myload('C:\Users\Nhat\Documents\Learning\Matlab\SCA-DPA-master\Samples\traces-00112233445566778899aabbccddeeff.bin', traceSize, offset, segmentLength, numberOfTraces);
%figure(2);
%plot(traces2(2,:));
